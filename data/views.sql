...
create or replace view v_entree_reste as(
    ...
    group by v_entree.idmouvement, v_entree.idArticle, v_entree.dateMouvement, v_entree.quantite_entree,v_entree.quantite_sortie,v_entree.entree,v_entree.sortie,v_entree.idmagasin
);
